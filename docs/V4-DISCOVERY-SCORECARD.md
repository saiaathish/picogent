...
Status: release-evidence and outcome-quality evidence refreshed on 2026-09-06
against the exact `main` merge
`a4a4de276091e8110576adb6bbf1f526ec007f5d`; feature/state reconciliation
remains bound to its named source heads. The matrix below is a historical
exact-head measurement, not a claim about later main merges. The
...
#427, #430, #431, #432, #434, #436, #442, and #447 merged. The bounded
release-evidence audit remains tracked in issue #316; prior audit observations
and their unverified boundaries are preserved below.

The remote `main` now includes PR #447 at merge
`a4a4de276091e8110576adb6bbf1f526ec007f5d`. Its fresh release-evidence audit
is recorded at the exact head in `docs/V4-RELEASE-AUDIT.md`; the post-merge
run `34003534333` passed all five hosted jobs. The verification manifest is
still `INCONCLUSIVE` and the scorecard's feature/state observations remain
bound to their named source heads.
